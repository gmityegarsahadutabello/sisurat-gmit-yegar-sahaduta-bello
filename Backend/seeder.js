...
const importData = async () => {
  try {
    ...
    const jemaatA = createdUsers.find(u => u.email === 'jemaat.a@gmityegar.com');
    const jemaatB = createdUsers.find(u => u.email === 'jemaat.b@gmityegar.com');
    ...
    const sampleNotifications = [
      {
        ...
        message: 'Pengajuan surat baptis Anda telah berhasil dibuat dan menunggu verifikasi koordinator.',
        pesan: 'Pengajuan surat baptis Anda telah berhasil dibuat dan menunggu verifikasi koordinator.',
      ...
      },
      {
        ...
        message: 'Ada pengajuan surat baru dari Rayon A yang perlu diverifikasi.',
